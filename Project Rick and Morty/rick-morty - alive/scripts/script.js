class RickMortyGeneratorAlive extends React.Component {
    ...
    async getChar() {
        let res = await fetch('https://rickandmortyapi.com/api/character/?page=1&name=rick&status=alive');
        let res2 = await fetch('https://rickandmortyapi.com/api/character/?page=2&name=rick&status=alive');
